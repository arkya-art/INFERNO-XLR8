//one publisher only to display value of uds sensor
...
ros::Publisher arduino("uds_distance", &int_msg);
...
void loop() { // This part of the code runs repeatedly
  ...
  delay(200); // Wait 200 ms before running again(this will set gap btween every data display on terminal of ros echo)
}
