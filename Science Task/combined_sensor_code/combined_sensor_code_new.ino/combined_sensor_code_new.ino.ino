    ...
    {                            //time interval: 1s
      ...
      //  phValue = float(ph.readPH(voltage,temperature));       // convert voltage to pH with temperature compensation
       ...
       {   ph = 7.0 ;
        ...
        if (voltage < 300 && voltage > 100)
       {   ph = 7.10 ;
        }
        if (voltage < 100 && voltage > 50)
       {  ph = 7.20 ;
        }
       ...
       if (voltage < 40 && voltage > 35)
       {  ph = 7.35 ;
       
       } 
        if (voltage < 35 && voltage > 30)
       {  ph = 7.36 ;
       
       } 
       
       if (voltage < 30 && voltage > 25)
       {  ph = 7.37 ;
       
       } 
       if (voltage < 25 && voltage > 20)
       {  ph = 7.39 ;
       
       } 
       if (voltage < 20 && voltage > 15)
       {  ph = 7.40 ;
       
       } 
       if (voltage < 15 && voltage > 10)
       {   ph = 7.50 ;
